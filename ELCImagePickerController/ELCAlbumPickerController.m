...
- (void)viewDidLoad {
    ...
    dispatch_async(dispatch_get_main_queue(), ^
    {
        ...
        void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
            ...
            UIAlertView * alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"error", @"error") message:[NSString stringWithFormat:NSLocalizedString(@"album_error", @"album error"), [error localizedDescription], [error localizedRecoverySuggestion]] delegate:nil cancelButtonTitle:NSLocalizedString(@"ok", @"ok") otherButtonTitles:nil];
            [alert show];
            [alert release];
...
-(void)reloadTableView {
	...
	[self.navigationItem setTitle:NSLocalizedString(@"select_an_album", @"Select an Album")];
}
